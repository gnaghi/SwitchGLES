...
/* GL_DEPTH_COMPONENT32 (0x81A7) is a desktop GL constant, not in GLES3.
 * GLES3 has GL_DEPTH_COMPONENT32F (0x8CAC) instead.
 * Define for compatibility with desktop GL code that uses this format. */
